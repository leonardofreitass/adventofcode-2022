(ns adventofcode-2022.exercises.day-7.part-2)
...
(defn run
  [inputs]
  (let [index (walk-and-index inputs)
        space-required (- 30000000 (- 70000000 (index "/")))]
    (first (sort (filter #(>= % space-required) (vals index))))))
